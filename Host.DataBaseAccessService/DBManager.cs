...
namespace Host.DataBaseAccessService
{
  ...
  public sealed class DBManager:  IDBManager, IDisposable
  {
      ...
      public DBManager()
      {
            ...
            string strConnectionString = "data source=192.168.100.141,1433;initial catalog=POSCORE;user id=audit;password=123456a@;MultipleActiveResultSets=true; Min Pool Size=10;Max Pool Size=1000;Pooling=true;";
