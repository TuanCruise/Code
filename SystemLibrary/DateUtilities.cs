...
namespace WB.SystemLibrary
{
	...
	public class DateUtilities
	{
		...
		public static DateTime GetStartOfCurrentWeek(DateTime dt)
		{
			...
			DateTime dtDate = 
				dt.Subtract( System.TimeSpan.FromDays( DaysToSubtract ) );
			return new DateTime( dtDate.Year, dtDate.Month, dtDate.Day, 0, 0, 0, 0 );
		}
		...
		public static DateTime GetEndOfCurrentWeek(DateTime dt)
		{
			DateTime dtDate = GetStartOfCurrentWeek(dt).AddDays(6);
			return new DateTime( dtDate.Year, dtDate.Month, dtDate.Day, 23, 59, 59, 999 );
		}
		...
		public static DateTime GetStartOfLastMonth()
		{
			if( DateTime.Now.Month == 1 )
				...
				return GetStartOfMonth( Month.December, DateTime.Now.Year );
		}
		...
		public static DateTime GetEndOfLastMonth()
		{
			if( DateTime.Now.Month == 1 )
				...
				return GetEndOfMonth( Month.December, DateTime.Now.Year );
		}
